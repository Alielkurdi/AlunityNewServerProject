...
import io.alunity.content.event.eventcalendar.ChallengeWinner;
import io.alunity.content.event.eventcalendar.EventCalendarDay;
import io.alunity.model.entity.player.Player;
import io.alunity.sql.DatabaseManager;
import io.alunity.sql.DatabaseTable;
import io.alunity.sql.displayname.RemoveDisplayNameSqlQuery;
...
import io.alunity.sql.eventcalendar.tables.EventCalendarWinnersTable;
...
class EventCalendarTablesTest {
    ...
    private static final Player player = TestPlayer.builder().username("Scott").build().player();
