...
import io.alunity.content.*;
import io.alunity.content.achievement.AchievementType;
import io.alunity.content.bosses.*;
import io.alunity.content.bosses.hespori.Hespori;
import io.alunity.content.bosspoints.BossPoints;
import io.alunity.content.combat.effects.damageeffect.impl.amuletofthedamned.impl.ToragsEffect;
import io.alunity.content.combat.melee.MeleeExtras;
import io.alunity.content.combat.weapon.WeaponMode;
import io.alunity.content.commands.all.Reclaim;
import io.alunity.content.compromised.CompromisedAccounts;
...
import io.alunity.content.donationrewards.DonationRewards;
import io.alunity.content.dwarfmulticannon.Cannon;
import io.alunity.content.event.eventcalendar.EventChallengeMonthlyReward;
import io.alunity.content.item.lootable.impl.*;
import io.alunity.content.items.PvpWeapons;
import io.alunity.content.itemskeptondeath.perdu.PerduLostPropertyShop;
import io.alunity.content.leaderboards.LeaderboardPeriodicity;
import io.alunity.content.leaderboards.LeaderboardUtils;
import io.alunity.content.minigames.tob.TobConstants;
import io.alunity.content.minigames.tob.TobContainer;
import io.alunity.content.minigames.tob.instance.TobInstance;
import io.alunity.content.party.PlayerParty;
import io.alunity.content.privatemessaging.FriendsList;
import io.alunity.content.minigames.raids.Raids;
import io.alunity.content.miniquests.magearenaii.MageArenaII;
import io.alunity.content.questing.Questing;
import io.alunity.content.teleportation.inter.TeleportInterface;
import io.alunity.content.tournaments.OutlastLeaderboardEntry;
import io.alunity.content.tutorial.ModeSelection;
import io.alunity.content.tutorial.TutorialDialogue;
import io.alunity.content.wogw.WogwContributeInterface;
import io.alunity.model.*;
import io.alunity.content.bosses.nightmare.NightmareConstants;
import io.alunity.content.combat.core.AttackEntity;
import io.alunity.content.combat.EntityDamageQueue;
import io.alunity.content.combat.formula.MeleeMaxHit;
import io.alunity.content.combat.melee.CombatPrayer;
import io.alunity.content.combat.melee.MeleeData;
import io.alunity.content.combat.weapon.CombatStyle;
import io.alunity.content.miniquests.MageArena;
...
import io.alunity.model.collisionmap.doors.Location;
import io.alunity.model.controller.Controller;
import io.alunity.model.controller.ControllerRepository;
import io.alunity.model.entity.player.lock.PlayerLock;
import io.alunity.model.entity.player.lock.Unlocked;
import io.alunity.model.entity.player.migration.PlayerMigrationRepository;
import io.alunity.model.entity.player.mode.ModeRevertType;
...
import io.alunity.model.entity.player.packets.ChangeAppearance;
import io.alunity.model.entity.player.save.PlayerAddresses;
import io.alunity.model.items.*;
import io.alunity.model.StringInput;
import io.alunity.model.multiplayersession.flowerpoker.FlowerPoker;
import io.alunity.model.multiplayersession.flowerpoker.FlowerPokerHand;
import io.alunity.model.tickable.Tickable;
import io.alunity.model.tickable.TickableContainer;
import io.alunity.model.definitions.ItemDef;
import io.alunity.model.entity.EntityReference;
...
import io.alunity.model.timers.TickTimer;
import io.alunity.net.PacketBuilder;
import io.alunity.model.cycleevent.CycleEventHandler;
import io.alunity.model.cycleevent.Event;
import io.alunity.model.cycleevent.impl.MinigamePlayersEvent;
import io.alunity.model.cycleevent.impl.RunEnergyEvent;
import io.alunity.model.cycleevent.impl.SkillRestorationEvent;
import io.alunity.content.item.lootable.unref.CoinBagBuldging;
import io.alunity.content.achievement.AchievementHandler;
import io.alunity.content.achievement.Achievements;
import io.alunity.content.achievement_diary.AchievementDiaryManager;
import io.alunity.content.achievement_diary.RechargeItems;
import io.alunity.content.bosses.godwars.God;
import io.alunity.content.bosses.godwars.Godwars;
import io.alunity.content.bosses.godwars.GodwarsEquipment;
import io.alunity.content.bosses.zulrah.Zulrah;
import io.alunity.content.cheatprevention.RandomEventInterface;
import io.alunity.content.collection_log.CollectionLog;
import io.alunity.content.combat.CombatItems;
import io.alunity.content.combat.Hitmark;
import io.alunity.content.combat.death.PlayerDeath;
import io.alunity.content.combat.magic.CombatSpellData;
import io.alunity.content.combat.melee.QuickPrayers;
import io.alunity.content.combat.stats.BossTimers;
import io.alunity.content.combat.stats.NPCDeathTracker;
...
import io.alunity.content.item.lootable.impl.VoteMysteryBox;
import io.alunity.content.item.lootable.impl.NormalMysteryBox;
import io.alunity.content.item.lootable.impl.PvmCasket;
import io.alunity.content.item.lootable.impl.SuperMysteryBox;
import io.alunity.content.item.lootable.impl.UltraMysteryBox;
import io.alunity.content.item.lootable.unref.CoinBagLarge;
import io.alunity.content.item.lootable.unref.CoinBagMedium;
import io.alunity.content.item.lootable.unref.CoinBagSmall;
import io.alunity.content.item.lootable.unref.DailyGearBox;
import io.alunity.content.item.lootable.unref.DailySkillBox;
import io.alunity.content.items.Degrade;
import io.alunity.content.items.pouch.GemBag;
import io.alunity.content.items.pouch.HerbSack;
import io.alunity.content.items.pouch.RunePouch;
import io.alunity.content.lootbag.LootingBag;
import io.alunity.content.minigames.bounty_hunter.BountyHunter;
import io.alunity.content.minigames.fight_cave.FightCave;
import io.alunity.content.minigames.inferno.Inferno;
import io.alunity.content.minigames.pest_control.PestControl;
import io.alunity.content.minigames.pest_control.PestControlRewards;
import io.alunity.content.minigames.pk_arena.Highpkarena;
import io.alunity.content.minigames.pk_arena.Lowpkarena;
import io.alunity.content.minigames.raids.RaidConstants;
import io.alunity.content.minigames.warriors_guild.WarriorsGuild;
import io.alunity.content.minigames.xeric.XericLobby;
import io.alunity.content.polls.PollTab;
import io.alunity.content.preset.Preset;
import io.alunity.content.prestige.PrestigeSkills;
import io.alunity.content.skills.Agility;
import io.alunity.content.skills.ExpLock;
import io.alunity.content.skills.SkillInterfaces;
import io.alunity.content.skills.agility.AgilityHandler;
import io.alunity.content.skills.agility.impl.BarbarianAgility;
import io.alunity.content.skills.agility.impl.GnomeAgility;
import io.alunity.content.skills.agility.impl.Lighthouse;
import io.alunity.content.skills.agility.impl.Shortcuts;
import io.alunity.content.skills.agility.impl.WildernessAgility;
import io.alunity.content.skills.agility.impl.rooftop.RooftopAlkharid;
import io.alunity.content.skills.agility.impl.rooftop.RooftopCanafis;
import io.alunity.content.skills.agility.impl.rooftop.RooftopDraynor;
import io.alunity.content.skills.agility.impl.rooftop.RooftopFalador;
import io.alunity.content.skills.agility.impl.rooftop.RooftopPollnivneach;
import io.alunity.content.skills.agility.impl.rooftop.RooftopRellekka;
import io.alunity.content.skills.farming.Farming;
import io.alunity.content.skills.fletching.Fletching;
import io.alunity.content.skills.herblore.Herblore;
import io.alunity.content.skills.hunter.Hunter;
import io.alunity.content.skills.mining.Mining;
import io.alunity.content.skills.prayer.Prayer;
import io.alunity.content.skills.slayer.Slayer;
import io.alunity.content.skills.smithing.Smelting;
import io.alunity.content.skills.smithing.Smithing;
import io.alunity.content.skills.smithing.SmithingInterface;
import io.alunity.content.skills.thieving.Thieving;
import io.alunity.content.titles.Titles;
import io.alunity.content.tournaments.TourneyManager;
import io.alunity.content.trails.TreasureTrails;
...
import io.alunity.model.entity.npc.pets.PetHandler;
import io.alunity.model.entity.player.mode.Mode;
import io.alunity.model.entity.player.mode.ModeType;
import io.alunity.model.entity.player.mode.RegularMode;
import io.alunity.model.items.bank.Bank;
import io.alunity.model.items.bank.BankPin;
import io.alunity.model.lobby.LobbyManager;
import io.alunity.model.lobby.LobbyType;
...
import io.alunity.model.multiplayersession.duel.Duel;
import io.alunity.model.multiplayersession.duel.DuelSession;
import io.alunity.model.multiplayersession.trade.Trade;
import io.alunity.model.shops.ShopAssistant;
import io.alunity.model.world.Clan;
import io.alunity.net.Packet;
import io.alunity.net.login.LoginReturnCode;
import io.alunity.net.login.RS2LoginProtocol;
import io.alunity.net.outgoing.UnnecessaryPacketDropper;
import io.alunity.sql.etc.HiscoresUpdateQuery;
import io.alunity.sql.outlast.OutlastLeaderboardAdd;
import io.alunity.util.ISAACCipher;
import io.alunity.util.Misc;
import io.alunity.util.Stopwatch;
import io.alunity.util.Stream;
import io.alunity.util.discord.Discord;
import io.alunity.util.logging.player.ChangeAddressLog;
import io.alunity.util.logging.player.ConnectionLog;
...
public class Player extends Entity {
    ...
    public io.alunity.content.preset.Set lastPreset;
    ...
    private final Queue<io.alunity.net.Packet> queuedPackets = new ConcurrentLinkedQueue<>();
    ...
    public void flushOutStream() {
        ...
        io.alunity.net.Packet packet = new io.alunity.net.Packet(-1, io.alunity.net.Packet.Type.FIXED, Unpooled.wrappedBuffer(temp));
