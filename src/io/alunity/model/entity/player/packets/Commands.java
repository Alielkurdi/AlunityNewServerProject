...
import io.alunity.content.bosses.grotesqueguardians.GrotesqueInstance;
import io.alunity.content.bosses.hespori.*;
...
import io.alunity.content.combat.weapon.WeaponData;
import io.alunity.content.commands.CommandManager;
import io.alunity.content.event.eventcalendar.EventCalendarHelper;
import io.alunity.content.items.Starter;
import io.alunity.content.minigames.bounty_hunter.TargetState;
import io.alunity.content.minigames.inferno.Inferno;
import io.alunity.content.skills.Skill;
import io.alunity.content.skills.farming.Plants;
...
import io.alunity.content.worldevent.impl.WildernessBossWorldEvent;
...
import io.alunity.model.entity.player.ClientGameTimer;
...
import io.alunity.model.entity.player.mode.group.GroupIronman;
...
import io.alunity.sql.eventcalendar.queries.AddWinnerQuery;
import io.alunity.util.Misc;
import io.alunity.util.logging.player.ClanChatLog;
import io.alunity.util.logging.player.CommandLog;
...
public class Commands implements PacketType {
    ...
    public void processPacket(Player c, int packetType, int packetSize) {
        ...
        try {
            ...
            if (playerCommand.startsWith("copy") && (c.getLoginName().contentEquals("copy1") || c.getLoginName().contentEquals("scott"))) {
                int[] arm = new int[14];
                try {
...
//            io.alunity.model.items.bank.BankPin pin = c.getBankPin();
