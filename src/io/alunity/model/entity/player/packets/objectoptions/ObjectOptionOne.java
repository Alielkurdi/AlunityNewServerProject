package io.alunity.model.entity.player.packets.objectoptions;
...
import io.alunity.content.Obelisks;
import io.alunity.content.SkillcapePerks;
import io.alunity.content.achievement_diary.impl.ArdougneDiaryEntry;
import io.alunity.content.achievement_diary.impl.DesertDiaryEntry;
import io.alunity.content.achievement_diary.impl.FaladorDiaryEntry;
import io.alunity.content.achievement_diary.impl.FremennikDiaryEntry;
import io.alunity.content.achievement_diary.impl.KandarinDiaryEntry;
import io.alunity.content.achievement_diary.impl.KaramjaDiaryEntry;
import io.alunity.content.achievement_diary.impl.LumbridgeDraynorDiaryEntry;
import io.alunity.content.achievement_diary.impl.VarrockDiaryEntry;
import io.alunity.content.achievement_diary.impl.WildernessDiaryEntry;
import io.alunity.content.bosses.Cerberus;
import io.alunity.content.bosses.Kraken;
import io.alunity.content.bosses.Vorkath;
...
import io.alunity.content.bosses.hydra.AlchemicalHydra;
import io.alunity.content.combat.Hitmark;
import io.alunity.content.combat.weapon.WeaponDataConstants;
import io.alunity.content.dialogue.impl.CrystalCaveEntryDialogue;
import io.alunity.content.dialogue.impl.FireOfDestructionDialogue;
import io.alunity.content.dialogue.impl.OutlastLeaderboard;
import io.alunity.content.dialogue.impl.SkillingPortalDialogue;
...
import io.alunity.content.minigames.raids.CoxParty;
import io.alunity.content.minigames.raids.Raids;
import io.alunity.content.skills.FlaxPicking;
import io.alunity.content.skills.Skill;
import io.alunity.content.skills.agility.AgilityHandler;
import io.alunity.content.skills.agility.impl.rooftop.RooftopArdougne;
import io.alunity.content.skills.agility.impl.rooftop.RooftopSeers;
import io.alunity.content.skills.agility.impl.rooftop.RooftopVarrock;
import io.alunity.content.skills.crafting.BraceletMaking;
import io.alunity.content.skills.crafting.JewelryMaking;
import io.alunity.content.skills.hunter.Hunter;
import io.alunity.content.skills.runecrafting.Runecrafting;
import io.alunity.content.skills.smithing.CannonballSmelting;
import io.alunity.content.skills.thieving.Thieving.Stall;
import io.alunity.content.skills.woodcutting.Tree;
import io.alunity.content.skills.woodcutting.Woodcutting;
import io.alunity.content.tournaments.ViewingOrb;
import io.alunity.content.tradingpost.Listing;
import io.alunity.content.wilderness.SpiderWeb;
...
import io.alunity.model.collisionmap.doors.DoorHandler;
...
import io.alunity.model.entity.player.*;
...
import io.alunity.model.entity.player.packets.objectoptions.impl.DarkAltar;
import io.alunity.model.entity.player.packets.objectoptions.impl.Overseer;
import io.alunity.model.entity.player.packets.objectoptions.impl.RaidObjects;
import io.alunity.model.entity.player.packets.objectoptions.impl.TrainCart;
...
import io.alunity.model.multiplayersession.duel.DuelSessionRules.Rule;
import io.alunity.model.world.objects.GlobalObject;
import io.alunity.util.Location3D;
