package io.alunity.model.entity.npc;
...
import io.alunity.content.achievement_diary.AchievementDiaryKills;
import io.alunity.content.bosses.Cerberus;
import io.alunity.content.bosses.Skotizo;
...
import io.alunity.content.combat.formula.rework.MagicCombatFormula;
import io.alunity.content.combat.formula.rework.RangeCombatFormula;
import io.alunity.content.combat.melee.MeleeExtras;
import io.alunity.content.instances.InstancedArea;
import io.alunity.content.minigames.barrows.brothers.Brother;
import io.alunity.content.minigames.fight_cave.Wave;
import io.alunity.content.minigames.inferno.InfernoWaveData;
import io.alunity.content.minigames.pest_control.PestControl;
import io.alunity.content.minigames.xeric.XericWave;
import io.alunity.content.questing.hftd.DagannothMother;
import io.alunity.content.skills.hunter.impling.PuroPuro;
...
import io.alunity.model.entity.npc.actions.LoadSpell;
import io.alunity.model.entity.npc.data.AttackAnimation;
...
public class NPCHandler {
    ...
    public static boolean isFightCaveNpc(NPC npc) {
        ...
        switch (npc.getNpcId()) {
        case io.alunity.content.minigames.fight_cave.Wave.TZ_KEK_SPAWN:
        case io.alunity.content.minigames.fight_cave.Wave.TZ_KIH:
        case io.alunity.content.minigames.fight_cave.Wave.TZ_KEK:
        case io.alunity.content.minigames.fight_cave.Wave.TOK_XIL:
        case io.alunity.content.minigames.fight_cave.Wave.YT_MEJKOT:
        case io.alunity.content.minigames.fight_cave.Wave.KET_ZEK:
        case Wave.TZTOK_JAD: 
            return true;
        }
        return false;
