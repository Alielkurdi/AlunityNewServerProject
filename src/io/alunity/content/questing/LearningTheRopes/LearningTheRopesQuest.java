package io.alunity.content.questing.LearningTheRopes;
...
import io.alunity.content.questing.Quest;
...
public class LearningTheRopesQuest extends Quest {
    ...
    public List<String> getJournalText(int stage) {
        ...
        switch (stage) {
            case 0:
                lines.add("To start this quest talk to the Alunity Guide");
            ...
            case 6:
                ...
                break;
            case 7:
                lines.add("I need to go kill a hobgoblin.");
                                            ...
                                            player.start(getAlunityGuide()
                                                    ...
                                                    .option(new DialogueOption("Sure, I can start now!", e -> {
                                                                ...
                                                                e.start(getAlunityGuide()
                                                                        ...
                                                                        .npc("The information these display", "will help you during your time in Alunity.")
    ...
    private DialogueBuilder getAlunityGuide() {
