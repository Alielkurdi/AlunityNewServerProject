...
import io.alunity.sql.FoxVote;
import io.alunity.sql.eventcalendar.queries.AddParticipantEntryOnVoteQuery;
import io.alunity.sql.vote.*;
import io.alunity.util.DateUtils;
import io.alunity.util.logging.player.VotedLog;
...
public class Voted extends Command {
	...
	public static void votePanel(Player player) {
	...
	public static void rewards(Player player, final int voteCount) {
		...
		// so this is the rewards section, for voting.
		// Coins
