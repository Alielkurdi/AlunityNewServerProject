...
public class Configuration {
    ...
    public static String SERVER_NAME = "Alunity";
    public static final int PORT_DEFAULT = 43594;
    public static final int PORT_TEST = 43595;

    public static final String PACKAGE = "io.alunity";
    public static final String DATA_FOLDER = "etc";

    public static final String WEBSITE = "https://www.alunity.net/";
    public static final String FORUM_TOPIC_URL = "https://www.xeros.io/index.php?/topic/";
    public static final String VOTE_LINK = "https://alunity.net/vote";
    public static final String HISCORES_LINK = "https://alunity.net/hiscores";
    public static final String STORE_LINK = "https://alunity.net/store";
    public static final String DISCORD_INVITE = "https://discord.gg/MgQGhweTJ7";
